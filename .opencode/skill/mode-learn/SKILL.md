...
name: mode-learn
description: >-
  Learn mode for explaining code, concepts, and architecture. Use when user asks
  to explain how things work, understand concepts, or learn about code patterns.
  Provides explanations from simple to complex with examples and analogies.
license: MIT
