...
description: >-
  Consulting mode for comparing options and making recommendations. Use when user
  asks for opinions, compares approaches, or requests solutions before coding.
  Provides 2-3 options with trade-offs and waits for confirmation.
license: MIT
